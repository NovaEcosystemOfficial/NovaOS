...
printf '%s\n' '0.2.8' > %{buildroot}/etc/novaos/version
printf '%s\n' 'milestone=0.2.8' 'channel=stable' 'delivered_by=nova-update' \
...
- NovaOS v0.2.8 identity (Nova Shell Foundation train)

* Sun Jul 26 2026 NovaOS Team <dev@novaos.local> - 0.2.7-1
- NovaOS v0.2.7 identity (Nova Hub train)

* Sun Jul 26 2026 NovaOS Team <dev@novaos.local> - 0.2.6-1
- NovaOS v0.2.6 identity (Nova Identity train)

* Sun Jul 26 2026 NovaOS Team <dev@novaos.local> - 0.2.5-1
- NovaOS v0.2.5 identity (Platform Foundation train)
