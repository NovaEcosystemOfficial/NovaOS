...
check "AUTOSTART" "[[ -f '${R}/etc/xdg/autostart/novaos-installer-autostart.desktop' ]]" "Live autostart entry"
check "AUTOSTART_BIN" "[[ -x '${R}/usr/sbin/novaos-autostart-installer.sh' ]]" "Live autostart script"
